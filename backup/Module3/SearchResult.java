    ...
    public Boolean verifySizeChartExists() {
        ...
        try {
             ...
             */
             ...
             status = verifySizeChart.getText().equalsIgnoreCase("Size Chart");
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders, List<List<String>> expectedTableBody,
        ...
        try {
             ...
             */
             ...
             List <WebElement> tableheader = parentElement.findElements(By.xpath("//table/thead/tr/th"));
             ...
             for(int i=0;i<expectedTableHeaders.size();i++){
                 ...
                 if(!expectedTableHeaders.get(i).equals(tempHeaderValue)){
                     System.out.println("Failure in header comparision: Expected " +expectedTableHeaders + "Actual: "+tempHeaderValue);
                     status = false;
                 }
             }
