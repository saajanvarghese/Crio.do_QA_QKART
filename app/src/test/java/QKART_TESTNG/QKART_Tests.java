...
//    Assert.assertFalse(status,"Test Case 2: Verify user Registration : FAIL");
...
//    // Assert.assertTrue(status,"Test Case Failure. Unable to search for given product: FAIL");
...
//         //return false;
//     }
//     //Assert.assertFalse(searchResults.size() == 0,"Test Case Failure. There were no results for the given search string : FAIL");
...
//             //return false;
//         }
//         Assert.assertTrue(elementText.toUpperCase().contains("YONEX"),"Test Case Failure. Test Results contains un-expected values: FAIL");
//     }
...
//     Assert.assertFalse(status,"Test Case Failure. Unable to search for given product: FAIL");
...
//         //return false;
//     }
//     Assert.assertFalse(searchResults.size() == 0,"TestCase 3:Test Case Fail. Expected: no results , actual: Results were available :FAIL");
