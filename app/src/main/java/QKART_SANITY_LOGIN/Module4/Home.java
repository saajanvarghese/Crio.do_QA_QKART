...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//p[contains(text(),'"+product+"')]"), product),
    ...
    public Boolean isNoResultFound() {
        ...
        try {  ////*[@id=\"root\"]/div/div/div[3]/div[1]/div[2]/div/h4
            status = driver.findElement(By.xpath("//div[3]/div/div[2]/div/h4")).isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             * 
             * Return true if these operations succeeds  css-sycj1h
             */
